...
//        }
    ...
    public String studentSave(StudentRequestDto studentRequestDto) {
        ...
        if (projectFirst == null) {
            ...
            project.setFirstName(studentRequestDto.getFirstName());
            project.setPathSecond(studentRequestDto.getPathSecond());
            project.setSecondName(studentRequestDto.getSecondName());
            project.setPathThird(studentRequestDto.getPathThird());
            project.setThirdName(studentRequestDto.getThirdName());
    ...
    public Map<String, Object> edit(Key key) {
        ...
        if (project != null) {
            ...
            studentDto.setFirstName(project.getFirstName());
            studentDto.setPathSecond(project.getPathSecond());
            studentDto.setSecondName(project.getSecondName());
            studentDto.setPathThird(project.getPathThird());
            studentDto.setThirdName(project.getThirdName());
    ...
    public List<MyProjectDto> myProject(String leaderAccount) {
        ...
        if (projects == null || projects.size() == 0){
            ...
            for (Project project : projects) {
                ...
                PGrade pGrade = studentDao.selectGrade(project.getSAccount(), project.getYear(), siptProcess.getStatus());
                if (!pGrade.getLevel().equals("")) {
                    myProjectDto.setAvg(pGrade.getLevel());
                } else {
                    myProjectDto.setAvg("-");
                }
