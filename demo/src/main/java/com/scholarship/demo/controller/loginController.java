...
//import com.scholarship.demo.model.User;
...
//    @ResponseBody
//    public String login(String account,String password,String role,HttpRequest httpRequest){
...
//        return new Result(200,"-",user.toString()).toString();
//    }
//
